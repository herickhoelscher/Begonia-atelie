...
const { validarItens, limpar, emailValido, metodoValido } = require("./_lib/validacao.js");
const { montarPedido } = require("./_lib/pedido.js");
const armazenamento = require("./_lib/armazenamento.js");
const { PAGAMENTO, DESCONTOS, UFS } = require("../src/js/dados.js");
