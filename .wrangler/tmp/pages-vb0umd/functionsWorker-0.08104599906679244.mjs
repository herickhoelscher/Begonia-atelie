...
var require_dados = __commonJS({
  "../frontend/js/dados.js"(exports, module) {
    ...
    var arredondar = /* @__PURE__ */ __name((valor) => Math.round(valor * 100) / 100, "arredondar");
...
var require_pedido = __commonJS({
  "../backend/lib/pedido.js"(exports, module) {
    ...
    var emCentavos = /* @__PURE__ */ __name((reais) => Math.round(Number(reais) * 100), "emCentavos");
    var emReais = /* @__PURE__ */ __name((centavos) => Math.round(centavos) / 100, "emReais");
...
// ../backend/gateways/mercadopago.js
...
// ../backend/gateways/infinitepay.js
var require_infinitepay = __commonJS({
  "../backend/gateways/infinitepay.js"(exports, module) {
    ...
    __name(chamar, "chamar");
    var emCentavos = /* @__PURE__ */ __name((reais) => Math.round(Number(reais) * 100), "emCentavos");
    var emReais = /* @__PURE__ */ __name((centavos) => Math.round(Number(centavos)) / 100, "emReais");
...
var require_simulado = __commonJS({
  "../backend/gateways/simulado.js"(exports, module) {
    ...
    module.exports = {
      ...
      registrarDecisao,
      extrairNotificacao,
      criarPagamentoUnico: /* @__PURE__ */ __name((args) => module.exports.criarPagamentoCartao(args), "criarPagamentoUnico"),
      criarPagamentoCartao,
      criarPagamentoPix,
      consultarPagamento,
      validarWebhook,
...
var require_gateway = __commonJS({
  "../backend/lib/gateway.js"(exports, module) {
    ...
    init_performance2();
    var implementacoes = {
      mercadopago: /* @__PURE__ */ __name(() => require_mercadopago(), "mercadopago"),
      infinitepay: /* @__PURE__ */ __name(() => require_infinitepay(), "infinitepay"),
      // Só para desenvolvimento: aprova sozinho, não cobra ninguém.
      // O próprio arquivo se recusa a rodar em produção.
      simulado: /* @__PURE__ */ __name(() => require_simulado(), "simulado")
    };
    function gateway() {
...
// api/config.js
var import_cloudflare, import_config, onRequest;
...
var require_validacao = __commonJS({
  "../backend/lib/validacao.js"(exports, module) {
    ...
    var soDigitos = /* @__PURE__ */ __name((valor) => String(valor || "").replace(/\D/g, ""), "soDigitos");
    ...
    function cpfValido(bruto) {
      ...
      const digito = /* @__PURE__ */ __name((fatia, pesoInicial) => {
        let soma = 0;
...
// ../backend/rotas/criar-pagamento.js
...
var import_cloudflare2, import_criar_pagamento, onRequest2;
...
// api/orcamento.js
var import_cloudflare3, import_orcamento, onRequest3;
...
// ../backend/rotas/simulado-pagar.js
...
var import_cloudflare4, import_simulado_pagar, onRequest4;
...
// ../backend/rotas/status-pagamento.js
...
var import_cloudflare5, import_status_pagamento, onRequest5;
...
// api/webhook.js
var import_cloudflare6, import_webhook, onRequest6;
...
// ../.wrangler/tmp/bundle-Cfbydb/middleware-loader.entry.ts
init_functionsRoutes_0_2508912819379314();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../.wrangler/tmp/bundle-Cfbydb/middleware-insertion-facade.js
init_functionsRoutes_0_2508912819379314();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
//# sourceMappingURL=functionsWorker-0.08104599906679244.mjs.map
