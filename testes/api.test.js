...
(async () => {
  console.log("\n== /api/config ==");
  {
    ...
    // Desligado enquanto a oferta de lancamento estiver no ar.
    checar("primeira compra desligada na oferta", r.json.descontoPrimeiraCompra === null, r.json.descontoPrimeiraCompra);
